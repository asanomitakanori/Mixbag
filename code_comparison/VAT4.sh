            ...
            do
                if [ $x -eq 1 ]; then
                    ...
                    do 
                        ...
                        do
                            python code_comparison/PL_VAT.py --dataset=$dataset --standard_normal_value=$standard --choice=$choice --ins=$ins --bags=$bags --classes=$classes --consistency=$cons --statistic=$static  --channels=$channels  --wrong_plp=False 
                        done
                    done
                elif [  $x -eq 0 ]; then
                    static=False
