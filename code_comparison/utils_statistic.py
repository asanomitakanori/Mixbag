...
class DatasetBag_randomchoice_statistic(torch.utils.data.Dataset):
    def __init__(self, args, data, label, lp):
        ...
        elif args.augmentation == 'contrast_brightness':
            self.transform = transforms.Compose([
                transforms.ToTensor(),
                transforms.Normalize((0.5071, 0.4865, 0.4409), (0.2673, 0.2564, 0.2762)),
        ...
        elif args.augmentation == 'posterize':
            self.transform = transforms.Compose([
                transforms.ToTensor(),
                transforms.Normalize((0.5071, 0.4865, 0.4409), (0.2673, 0.2564, 0.2762)),
        ...
        elif args.augmentation == 'gaussblur':
            self.transform = transforms.Compose([
                transforms.ToTensor(),
                transforms.Normalize((0.5071, 0.4865, 0.4409), (0.2673, 0.2564, 0.2762)),
